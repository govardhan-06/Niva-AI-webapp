...
import { tokenManager, authAPI as authService } from '../services/auth';
  ...
  const checkUserRole = async () => {
    try {
      ...
      if (userDataResponse.user) {
        ...
        console.log('Current user role:', role, 'isAdmin:', tokenManager.isAdmin());
      } else {
    ...
    return (
      <div className="course-list">
        ...
        <div className="empty-state">
          ...
          <p>
            {isAdmin 
              ? 'Niva AI is your intelligent interviewer that helps you practice and improve your skills. Create your first course to get started with personalized AI-powered interviews.'
              : 'Niva AI is your intelligent interviewer that helps you practice and improve your skills. Browse available courses to start your personalized AI-powered interviews.'}
          </p>
